...
class TestCookbook08JWS:
    ...
    def test_4_1_signing(self):
        ...
        assert JWS_compact_4_1_3 == s.serialize(compact=True)
    ...
    def test_4_6_signing(self):
        ...
        sig = s.serialize()
        s.deserialize(sig, key)
        assert json_decode(sig) == JWS_flattened_4_6_3
        # Just deserialize each example form
    ...
    def test_4_7_signing(self):
        ...
        sig = s.serialize()
        s.deserialize(sig, key)
        assert json_decode(sig) == JWS_flattened_4_7_3
        # Just deserialize each example form
